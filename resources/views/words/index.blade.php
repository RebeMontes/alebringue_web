...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex gap-3">
            ...
            <!-- Botón nueva palabra -->
            <a href="{{ route('words.create') }}" class="btn-primary flex items-center gap-2 text-sm font-bungee tracking-wide">
        ...
        <div class="stat-card p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="w-10 h-10 bg-[#00E5FF]/20 rounded-full flex items-center justify-center">
                    <i class="fas fa-tags text-[#00E5FF] text-xl"></i>
                </div>
            </div>
        </div>
        ...
        <div class="stat-card p-4">
            <div class="flex items-center justify-between">
                ...
                <div class="w-10 h-10 bg-green-500/20 rounded-full flex items-center justify-center">
                    <i class="fas fa-volume-up text-green-400 text-xl"></i>
                </div>
            </div>
        </div>
            ...
            <table class="min-w-full divide-y divide-ale-border">
                <thead>
                    <tr class="bg-ale-surface-light">
                        <th class="px-4 py-4 text-left text-xs font-bungee text-[#E0007C] uppercase tracking-wider">PALABRA</th>
                        <th class="px-4 py-4 text-left text-xs font-bungee text-[#E0007C] uppercase tracking-wider">TRADUCCIÓN</th>
                        <th class="px-4 py-4 text-left text-xs font-bungee text-[#E0007C] uppercase tracking-wider">PRONUNCIACIÓN</th>
                        <th class="px-4 py-4 text-left text-xs font-bungee text-[#E0007C] uppercase tracking-wider">CATEGORÍA</th>
                    ...
                    <tr class="word-row hover:bg-ale-surface/50 transition-colors" data-word="{{ strtolower($word->word) }}" data-translation="{{ strtolower($word->translation) }}" data-category="{{ strtolower($word->category->name ?? '') }}">
                        <td class="px-4 py-4 align-middle">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 bg-[#E0007C]/20 rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <td class="px-4 py-4 align-middle">
                            <div class="flex items-center justify-center gap-3">
                                ...
                                <a href="{{ route('words.show', $word->id) }}" class="text-ale-text-dim hover:text-[#00E5FF] transition p-1" title="Ver detalles">
                    ...
                    <tr>
                        <td colspan="5" class="px-4 py-16 text-center">
                            <div class="flex flex-col items-center gap-4">
                                ...
                                <a href="{{ route('words.create') }}" class="btn-primary text-sm mt-2 font-bungee">CREAR PRIMERA PALABRA</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
<script>
    ...
    document.getElementById('btn-exportar')?.addEventListener('click', function() {
        ...
        toast.innerHTML = `
            ...
            <div class="flex-1">
                <p class="text-sm text-ale-text font-bungee">PALABRAS EXPORTADAS CORRECTAMENTE</p>
            </div>

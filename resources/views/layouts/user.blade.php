...
<body class="min-h-screen bg-ale-bg">
    ...
    <div class="flex flex-col min-h-screen">
            ...
            <div class="flex items-center justify-between px-4 py-3 md:px-6">
                ...
                <div class="flex items-center space-x-3">
                    <div class="flex items-center">
                        <a href="/" class="inline-block focus:outline-none" aria-label="Ir al inicio de Alebringüe">
                            <img src="{{ asset('images/Logo.png') }}" alt="Logo Alebringüe"
                                class="w-auto h-12 md:h-16 object-contain" loading="eager" decoding="async">
                        </a>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button class="relative text-ale-text-dim hover:text-ale-pink transition">
                        ...
                        <span
                            class="absolute -top-1 -right-2 w-4 h-4 bg-ale-pink rounded-full text-[10px] flex items-center justify-center text-white"></span>
                    </button>
                    ...
                    <div class="relative" x-data="{ open: false }" @click.away="open = false">
                        <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none">
                            <div
                                class="w-9 h-9 bg-gradient-to-r from-ale-pink to-pink-600 rounded-full flex items-center justify-center avatar-ale">
                                <i class="fas fa-user text-white text-sm"></i>
                            </div>
                            <span
                                class="hidden md:block text-ale-text text-sm font-medium">{{ Auth::user()->name ?? 'Usuario' }}</span>
                            <i class="fas fa-chevron-down text-ale-text-dim text-xs hidden md:block"></i>
                        </button>

                        <div x-show="open" x-cloak
                            class="absolute right-0 mt-2 w-56 bg-ale-surface border border-ale-border rounded-xl shadow-xl z-50"
                            style="display: none;">
                            <div class="p-3 border-b border-ale-border">
                                <p class="text-ale-text font-medium text-sm">{{ Auth::user()->name ?? 'Invitado' }}</p>
                                <p class="text-ale-text-dim text-xs">{{ Auth::user()->email ?? 'usuario@ejemplo.com' }}
                                </p>
                            ...
                            <div class="border-t border-ale-border py-2">
                                <!-- AQUÍ ESTÁ EL CAMBIO: El formulario envuelve al botón -->
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="sidebar-link w-full text-left px-4 py-2 text-sm text-red-400 hover:text-red-300">
        ...
        <div class="flex flex-1">
            ...
            <!-- Sidebar User -->
            <aside id="sidebar"
                class="mobile-menu-hidden sidebar-transition fixed md:relative z-20 w-64 bg-ale-surface border-r border-ale-border flex-shrink-0 h-full md:h-auto overflow-y-auto">
                <div class="p-4">
                    <!-- Perfil resumen -->
                    <div class="mb-6 p-3 bg-ale-surface-light rounded-xl border border-ale-border">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-12 h-12 bg-gradient-to-r from-ale-pink to-pink-600 rounded-full flex items-center justify-center avatar-ale">
                    ...
                    <nav>
                        ...
                        <!-- Descarga app -->
                        <div
                            class="mt-4 p-3 bg-gradient-to-r from-ale-pink/20 to-transparent rounded-xl border border-ale-pink/30">
                            ...
                            <div class="flex gap-2">
                                <a href="#" class="text-ale-text-dim hover:text-ale-pink text-xs"><i
